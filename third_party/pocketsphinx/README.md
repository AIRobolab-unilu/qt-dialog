...
Please note that this code has been modified a little by [**Thomas Sauvage**](https://github.com/SauvageThomas) to prevent the node to listen when the robot is speaking.
